...
public class Utl {
    ...
    static
    public DisplayMetrics getDisplayMetrics( Context ctx){
    ...
    static
    public float px2dp( Context ctx, int px){
    ...
    static
    public String getResStr( Context ctx, int resId){
        return ctx.getResources().getString( resId);
    }
    static
    public String getResStr( Context ctx, int resId, String arg1){
        return ctx.getResources().getString( resId, arg1);
    }
    static
    public String getResStr( Context ctx, int resId, String arg1, String arg2){
