...
import com.github.ksoichiro.android.observablescrollview.ObservableScrollBaseActivity;

import java.util.ArrayList;

public abstract class ObservableScrollBaseFragment extends Fragment {
    public static ArrayList<String> getDummyData() {
        return ObservableScrollBaseActivity.getDummyData();
    }
